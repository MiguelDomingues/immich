...
import { UserAvatarColor, UserMetadata, UserMetadataEntity, UserMetadataKey } from 'src/entities/user-metadata.entity';
...
export class UserResponseDto {
  ...
  license!: UserMetadata[UserMetadataKey.LICENSE] | null;
}
